...
map.getView().fit([8527769.855756, 1035417.133931, 8547829.209034, 1046385.721681], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aranmula_web</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (9 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'racticing';
            }
